...
os.chdir('/Users/willsigal/Documents/GitHub/problem-set-4-andy-fan-will-sigal') #will wd

#os.chdir('d:\\UChicago\\Classes\\2024Qfall\\Programming Python\\problem-set-4-andy-fan-will-sigal') #andy wd
...
distances = []
for i, texas_zip in subset_texas_centroids.iterrows():
...
full_distances = []
for i, texas_zip in zips_texas_centroids.iterrows():
    min_distance = zips_withhospital_centroids.distance(texas_zip.geometry).min()
