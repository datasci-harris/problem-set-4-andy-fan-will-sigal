...
```{python}
### altair plot
chartQ1_4 = alt.Chart(df).mark_line().encode(
    x= alt.X('year:C', axis=alt.Axis(labelAngle=45)),
    y= alt.Y('count:Q', bin=alt.BinParams(maxbins=40), title='number of hospitals', sort='descending')
).properties(
    width=800, 
    height=400, 
    title='Short-Term Hospitals by Year'  
)
chartQ1_4
```
